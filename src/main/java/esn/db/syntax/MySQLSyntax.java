...
public class MySQLSyntax{
    ...
    public final String CREATE_TABLE_CONSTRAINTS = " (id int not null auto_increment primary key, message varchar(500), userId int, time timestamp, orgId int)"; //TODO TIMESTAMP?
